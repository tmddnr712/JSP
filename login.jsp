	...
	<div class="container"> <!-- 컨테이너 처럼 감싸기 -->
		...
		<div class="col-lg-4"><!-- 로그인 양식 -->
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="joinAction.jsp"> <!-- form = 양식, post는 회원가입이나 로그인같이 정보를 숨기면서 보낼때 사용하는 method loginAction에 로그인정보를 보냄 -->
					...
					<input type="submit" class="btn btn-primary forn-control" value="로그인"> <!-- 로그인 버튼 -->
				</form>
			</div>
		</div>
		<div class="col-lg-4"></div>
